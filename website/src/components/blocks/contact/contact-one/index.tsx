    ...
    return (
        <section className="py-32">
            <div className="mx-auto max-w-3xl px-8 lg:px-0">
                <h1 className="text-center text-4xl font-semibold lg:text-5xl">Contact Our Team</h1>
                <p className="mt-4 text-center">Let's discuss how Elemente can transform your outreach and pricing for your business.</p>
